...
class ColorsHelper {
    ...
    static getColor(colorString = "", subCode = "", hex = true) {
        ...
        if (hex) {
            return colors[colorString][String(subCode)];
        } else {
            // convert color to hexadecimal number
            return Phaser.Display.Color.HexStringToColor(colors[colorString][String(subCode)]).color;
        }
    }
